...
function updateBackground(rgbObject) {
  ...
  rgb332Text.textContent =
    hexPrefix + rgbObject.color8.toString(16).toUpperCase()
...
function addColors() {
  ...
  for (var i = 0; i <= 0xff; i++) {
    ...
    var cubeToRGBTrack = new THREE.VectorKeyframeTrack('.position', animTimes, [
      xHSV,
      yHSV,
      zHSV,
      xRGB,
    ...
    var cubeToRGBClip = new THREE.AnimationClip('CubeToRGB' + i, -1, [
      cubeToRGBTrack,
    ])
    ...
    var cubeToHSVTrack = new THREE.VectorKeyframeTrack('.position', animTimes, [
      xRGB,
      yRGB,
      zRGB,
      xHSV,
    ...
    var cubeToHSVClip = new THREE.AnimationClip('CubeToHSV' + i, -1, [
      cubeToHSVTrack,
    ])
    ...
    var rotorToRGBClip = new THREE.AnimationClip('RotorToRGB' + i, -1, [
      rotorToRGBTrack,
    ])
    ...
    var rotorToHSVClip = new THREE.AnimationClip('RotorToHSV' + i, -1, [
      rotorToHSVTrack,
    ])
  ...
  var cylToRGBTrackV = new THREE.VectorKeyframeTrack('.position', animTimes, [
    0,
    0,
    0,
    xScale / 2,
  ...
  var hsvCylToRGBClip = new THREE.AnimationClip('CylinToRGB', -1, [
    cylToRGBTrackQ,
    cylToRGBTrackV,
  ])
  ...
  var hsvCylToHSVClip = new THREE.AnimationClip('CylinToHSV', -1, [
    cylToHSVTrackV,
    cylToRGBTrackV,
  ])
